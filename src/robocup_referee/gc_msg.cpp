...
std::string GCMsg::to_string() const
{
  ...
  for (int t = 0; t < 2; t++)
  {
    ...
    m << "  / goal : " << (int)teams[t].goalkeeper << "(" << colorStr((int)teams[t].goalkeeperColour) << ")"
      << std::endl;
